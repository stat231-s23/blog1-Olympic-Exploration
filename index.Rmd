...
#GDP Map 1960
mapplot3 <- ggplot(map_data_gdp2, aes(x = long, y = lat, group = group, fill = gdp, text = region)) +
  geom_polygon(color = "black") +
  scale_fill_viridis(option = "magma", direction = -1) + 
...
#Population Map 1960
mapplot4 <- ggplot(map_data_gdp2, aes(x = long, y = lat, group = group, fill = Count, text = region)) +
  geom_polygon(color = "black") +
  scale_fill_viridis(option = "mako", direction = -1) + 
